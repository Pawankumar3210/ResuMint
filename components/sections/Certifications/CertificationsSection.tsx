  ...
  return (
    <div className="flex flex-col gap-4">
      <label className="flex cursor-pointer items-center gap-2 text-sm text-foreground transition-colors hover:text-primary">
        <input
          type="checkbox"
          checked={resume.certificationsEnabled}
          onChange={(e) => setCertificationsEnabled(e.target.checked)}
          className="h-4 w-4 rounded accent-primary transition-transform"
        />
        Include a certifications section on my resume
      </label>

      <CollapsibleReveal show={resume.certificationsEnabled}>
